...
def force(load_from_pickle = False, data_path = r'StoredValues/', grid=0, date='2024_'):
    if not load_from_pickle:
        ...
        with open(data_path + '/d_' + date + str(grid) + '.pkl', "wb") as output_file:
            pickle.dump(d, output_file)
        with open(data_path + '/F_' + date + str(grid) + '.pkl', "wb") as output_file:
            pickle.dump(F, output_file)
        with open(data_path + '/t_' + date + str(grid) + '.pkl', "wb") as output_file:
            pickle.dump(t, output_file)
            
    else:
        with open(data_path + '/d_' + date + str(grid) + '.pkl', "rb") as output_file:
            d = pickle.load(output_file)
        with open(data_path + '/F_' + date + str(grid) + '.pkl', "rb") as output_file:
            F = pickle.load(output_file)
        with open(data_path + '/t_' + date + str(grid) + '.pkl', "rb") as output_file:
