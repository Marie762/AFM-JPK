...
#     argmin_list3 = contactPoint3(F_bS, d_hC, plot='True', perc_bottom=10, perc_top=90, multiple=35, multiple1=25, multiple2=10) # , multiple=25, multiple1=20, multiple2=10
...
contact_point_height3 = QIcontactPoint3(F,d, perc_bottom=0, perc_top=80)
